...
public class BoardPagingUtil {
	 ...
	 */
	public BoardPagingUtil(int currentPageNum) {
	 ...
	 */
	public BoardPagingUtil(int currentPageNum, int objectCountPerPage, int pageNumCountPerPage) {
		this.currentPageNum = (0 < currentPageNum) ? currentPageNum : 1 ;
	...
	public String toString() {
		return "BoardPagingUtil [currentPageNum=" + currentPageNum + ", objectCountTotal=" + objectCountTotal
